...
CREATE TABLE "new_day_habits" (
    ...
    CONSTRAINT "day_habits_date_id_fkey" FOREIGN KEY ("date_id") REFERENCES "days" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "day_habits_habit_id_fkey" FOREIGN KEY ("habit_id") REFERENCES "habits" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
INSERT INTO "new_day_habits" ("date_id", "habit_id", "id") SELECT "date_id", "habit_id", "id" FROM "day_habits";
